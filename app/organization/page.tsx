            ...
            <div className="border-b border-slate-800 mb-6">
                <div className="flex space-x-4 sm:space-x-8 overflow-x-auto pb-2 scrollbar-hide">
                    <button
                        ...
                        className={`px-3 sm:px-4 py-3 border-b-2 transition-colors whitespace-nowrap text-sm sm:text-base ${activeTab === 'general' ? 'border-blue-500 text-blue-500' : 'border-transparent text-slate-400 hover:text-slate-300'
                            }`}
                    >
                        General
                    </button>
                    <button
                        ...
                        className={`px-3 sm:px-4 py-3 border-b-2 transition-colors whitespace-nowrap text-sm sm:text-base ${activeTab === 'credentials' ? 'border-blue-500 text-blue-500' : 'border-transparent text-slate-400 hover:text-slate-300'
                            }`}
                    >
                        API Credentials
                    </button>
                    <button
                        ...
                        className={`px-3 sm:px-4 py-3 border-b-2 transition-colors whitespace-nowrap text-sm sm:text-base ${activeTab === 'users' ? 'border-blue-500 text-blue-500' : 'border-transparent text-slate-400 hover:text-slate-300'
                            }`}
                    >
                        Users
                    </button>
                    <button
                        ...
                        className={`px-3 sm:px-4 py-3 border-b-2 transition-colors whitespace-nowrap text-sm sm:text-base ${activeTab === 'resources' ? 'border-blue-500 text-blue-500' : 'border-transparent text-slate-400 hover:text-slate-300'
                            }`}
                    >
                        Resource Limits
                    </button>
                    <button
                        ...
                        className={`px-3 sm:px-4 py-3 border-b-2 transition-colors whitespace-nowrap text-sm sm:text-base ${activeTab === 'api-requests' ? 'border-blue-500 text-blue-500' : 'border-transparent text-slate-400 hover:text-slate-300'
                            }`}
                    >
                        API Key Requests
                    </button>
