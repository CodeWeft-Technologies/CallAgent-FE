                    ...
                    <div className={`px-8 pb-8 ${footerClassName}`}>
                        <div className={`mt-10 flex ${currentStep !== 1 ? 'justify-between' : 'justify-end'}`}>
                            ...
                            <button
                                ...
                                className="duration-350 flex items-center justify-center rounded-full bg-emerald-500 py-2 px-6 font-medium tracking-tight text-white transition hover:bg-emerald-600 active:bg-emerald-700"
                                {...nextButtonProps}
                            >
...
function StepConnector({ isComplete }: StepConnectorProps) {
    ...
    return (
        <div className="relative mx-4 h-0.5 flex-1 overflow-hidden rounded bg-slate-600">
            <motion.div
