  ...
  return (
    ...
    >
      ...
      >
        ...
        <header
          className="staggered-menu-header absolute top-0 left-0 w-full flex items-center justify-between p-[2em] bg-transparent pointer-events-none z-[999]"
        ...
        >
          ...
          <button
            ref={toggleBtnRef}
            className={`sm-toggle relative inline-flex items-center gap-[0.3rem] backdrop-blur-sm rounded-full px-4 py-2 cursor-pointer font-medium leading-none overflow-visible pointer-events-auto transition-all duration-300 ${
              open 
